...
class OpenImagesRare(data.Dataset):
    def __init__(self, root, data_split, transform=None, start_idx=0):
        ...
        self.root = root
        classnames = []
        class_name_file = 'rare/openimages_rare_200_ram_taglist.txt'
        ...
        image_list_file = os.path.join(self.root, 'rare/openimages_rare_200_ram_annots.txt')
    ...
    def name(self):
        return 'openimagesv6_rare'


if __name__ == '__main__':
  root_path = '/projectnb/ivc-ml/sunxm/datasets/OpenImagesV6/'
  data_split = 'test'
  dataset = OpenImagesRare(root_path,  data_split)
  batch = dataset[100]
  import pdb
  pdb.set_trace()
