...
class_map_cls_id_to_class = {
    'birdsnap':  dict(zip(range(len(birdsnap_classes)), birdsnap_classes)),
    'gtsrb': dict(zip(range(len(gtsrb_classes)), gtsrb_classes)),
    'cifar-10': dict(zip(range(len(cifar10_classes)), cifar10_classes)),
    'caltech-101': dict(zip(range(len(caltech101_classes)), caltech101_classes)),
    'cifar-100': dict(zip(range(len(cifar100_classes)), cifar100_classes)),
    'country211': dict(zip(range(len(country211_classes)), country211_classes)),
    'fgvc-aircraft-2013b-variants102': dict(zip(range(len(fgvcaircraft_classes)), fgvcaircraft_classes)),
    'oxford-flower-102': dict(zip(range(len(flowers102_classes)), flowers102_classes)),
    'food-101': dict(zip(range(len(food101_classes)), food101_classes)),
    'kitti-distance': dict(zip(range(len(kitti_classes)), kitti_classes)),
    'mnist': dict(zip(range(len(mnist_classes)), mnist_classes)),
    'patch-camelyon': dict(zip(range(len(patchcamelyon_classes)), patchcamelyon_classes)),
    'resisc45_clip': dict(zip(range(len(resisc45_classes)), resisc45_classes)),
    'stl10': dict(zip(range(len(stl10_classes)), stl10_classes)),
    'sun397': dict(zip(range(len(sun397_classes)), sun397_classes)),
    'stanford-cars': dict(zip(range(len(stanfordcars_classes)), stanfordcars_classes)),
    'ucf101': dict(zip(range(len(ucf101_classes)), ucf101_classes)),
    'voc-2007-classification': dict(zip(range(len(pascalvoc2007_classes)), pascalvoc2007_classes)),
    'oxford-iiit-pets': dict(zip(range(len(oxfordpets_classes)), oxfordpets_classes)),
    'eurosat_clip': dict(zip(range(len(eurosat_classes)), eurosat_classes)),
    'hateful-memes': dict(zip(range(len(hatefulmemes_classes)), hatefulmemes_classes)),
    'rendered-sst2': dict(zip(range(len(sst2_classes)), sst2_classes)),
    'dtd': dict(zip(range(len(describabletextures_classes)), describabletextures_classes)),
    'fer-2013': dict(zip(range(len(facialemotionrecognition2013_classes)), facialemotionrecognition2013_classes)),
    'imagenet-1k': dict(zip(range(len(imagenet_classes)), imagenet_classes)),
    'imagenetv2': dict(zip(range(len(imagenet_classes)), imagenet_classes)),
    'imagenet-sketch': dict(zip(range(len(imagenet_classes)), imagenet_classes)),
    'imagenet-r': dict(zip(range(len(imagenet_r_classes)), imagenet_r_classes)),
    'imagenet-a': dict(zip(range(len(imagenet_a_classes)), imagenet_a_classes)),
    'objectnet': dict(zip(range(len(objectnet_classes)), objectnet_classes))
}
