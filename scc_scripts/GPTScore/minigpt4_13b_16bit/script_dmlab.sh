...
python GPTScore_eval.py  --batch_size 32 --eval_coco    -device $DEVICE --coco_prompts " " --model "minigpt4" --cfg-path $CFG_PATH --dataset_name wds/vtab/dmlab --output_dir ./snapshot/GPTScore/minigpt4/dmlab