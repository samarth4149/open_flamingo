...
python GPTScore_eval.py  --batch_size 32 --eval_coco --coco_dataroot    ../../datasets/    -device $DEVICE --coco_prompts "a photo of a " --model "minigpt4" --cfg-path $CFG_PATH --dataset_name resisc45_clip