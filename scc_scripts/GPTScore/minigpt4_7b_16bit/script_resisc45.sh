...
python GPTScore_eval.py  --batch_size 64 --eval_coco --coco_dataroot    ../../datasets/    -device $DEVICE --coco_prompts "satellite imagery of " --model "minigpt4" --cfg-path $CFG_PATH --dataset_name resisc45_clip