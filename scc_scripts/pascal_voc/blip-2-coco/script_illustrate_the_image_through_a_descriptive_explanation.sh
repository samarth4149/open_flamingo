...
python caption_evaluate.py  --batch_size 32 --eval_coco --coco_dataroot /projectnb/ivc-ml/sunxm/datasets/VOCdevkit/VOC2007/  --processor_path $PROCESSOR_PATH --device $DEVICE --coco_prompts "illustrate the image through a descriptive explanation" --model "blip" --lm_path $LM_PATH   --dataset_name pascal_voc
