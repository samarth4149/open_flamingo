...
python caption_evaluate.py  --batch_size 16 --eval_coco --coco_dataroot    ../../datasets/mscoco_2014/    -device $DEVICE --coco_prompts "illustrate the image through a descriptive explanation " --model "minigpt4" --cfg-path $CFG_PATH
