...
python caption_evaluate.py  --batch_size 32 --eval_coco --coco_dataroot    ../../datasets/mscoco_2014/    -device $DEVICE --coco_prompts "offer a thorough analysis of the image " --model "minigpt4" --cfg-path $CFG_PATH
