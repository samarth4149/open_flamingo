...
python caption_evaluate.py  --batch_size 16 --eval_coco --coco_dataroot    ../../datasets/mscoco_2014/    -device $DEVICE --coco_prompts "clarify the contents of the displayed image with great detail " --model "minigpt4" --cfg-path $CFG_PATH
