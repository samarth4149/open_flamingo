...
python caption_evaluate.py  --batch_size 32 --eval_coco --coco_dataroot /projectnb/ivc-ml/sunxm/datasets/mscoco_2014/  --processor_path $PROCESSOR_PATH --device $DEVICE --coco_prompts "characterize the image using a well-detailed description" --model "blip" --lm_path $LM_PATH
