...
python caption_evaluate.py  --batch_size 32 --eval_coco --coco_dataroot /projectnb/ivc-ml/sunxm/datasets/mscoco_2014/  --processor_path $PROCESSOR_PATH --device $DEVICE --vqa --model "blip" --lm_path $LM_PATH --output_dir snapshots/blip_vqa --save_freq 10