...
python caption_evaluate.py  --batch_size 32 --eval_coco --coco_dataroot /projectnb/ivc-ml/sunxm/datasets/OpenImagesV6/   --processor_path $PROCESSOR_PATH --device $DEVICE --coco_prompts "Caption:" --model "blip" --lm_path $LM_PATH  --dataset_name OpenImagesV6Common
